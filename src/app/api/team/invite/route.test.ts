...
describe('POST /api/team/invite', () => {
  ...
  it('rejects a client_admin targeting a different client_id with 403', async () => {
    ...
    // actually reach client-2 — asserted indirectly via the invite email
    // being sent at all (it succeeds because targetClientId resolves to
    // their own client, not the spoofed one).
